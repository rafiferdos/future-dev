            ...
            <div className="hero-content flex-col lg:flex-row-reverse">
              ...
              <div className="max-w-xl">
                ...
                <p className="font-medium mb-5 lg:text-xl text-[#2e2e2e]">
                  ...
                  students not only learn theory but also apply their knowledge
                  through real-world projects and fun challenges.
                </p>
                <Button text="Join Today" link="#" />
              </div>
            </div>
            ...
            <div className="hero-content flex-col lg:flex-row-reverse">
              ...
              <div className="max-w-xl">
                ...
                <p className="font-medium mb-5 lg:text-xl text-[#2e2e2e]">
                  ...
                  flexible class schedules that fit around your child busy life.
                </p>
                <Button text="Join Today" link="#" />
              </div>
            </div>
          ...
          <div className="hero bg-[#1313130D] mb-20 h-[550px] lg:h-[650px] rounded-3xl">
            <div className="hero-content flex-col lg:flex-row-reverse">
              ...
              <div className="max-w-xl">
                ...
                <p className="font-medium mb-5 lg:text-xl text-[#2e2e2e]">
                  Each course is designed around practical projects that inspire
                  creativity and innovation, from building games to programming
                  robots.
                </p>
                <Button text="Join Today" link="#" />
              </div>
